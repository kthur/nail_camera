...
def main():
    ...
    configs = {
        ...
        "Config_B_6Classes_Optimized": {
            "pale_s_max": 0.1969, "pale_v_min": 0.4823, "pale_r_max": 175.1511,
            "low_r_max": 121.2894, "low_r_ratio_b": 0.9755, "low_r_min_abs": 94.1006,
            "white_ratio_min": 0.4410,
            "texture_score_min": 0.6695, "red_std_min": 108.6932,
            "dark_ratio_min": 0.2931
        },
        "Config_C_Tuned_Hybrid": {
            "pale_s_max": 0.1600, "pale_v_min": 0.4500, "pale_r_max": 185.0000,
            "low_r_max": 125.0000, "low_r_ratio_b": 0.9700, "low_r_min_abs": 100.0000,
            "white_ratio_min": 0.3800,
            "texture_score_min": 0.6200, "red_std_min": 105.0000,
            "dark_ratio_min": 0.2900
        }
    }
    ...
    for name, th in configs.items():
        ...
        print(f"F1 Sum: {f1_sum:.4f} | Average F1: {avg_f1:.4f}")
        print(f"==================================================")
